export default [
  {
    ...
    imageUrl: require("./assets/projects_images/mouse_yoke.png"),
    shortDesc: {
    ...
    longDesc: {
      en:
        "Use your mouse to control an airplane's yoke without the need of expensive equipment. It has already helped over 2,000 users, including individuals with disabilities, in enjoying Flight Simulator 2020. It insures a configurable way to emulate controller outputs by listening to the mouse position.",
      es:
        "Esta herramienta permite usar el mouse como instrumento de vuelo en Microsoft Flight Simulator 2020. Posee más de 2.000 usuarios, incluyendo a personas con discapacidades. Brinda una forma configurable de emular un controlador, escuchando la posición del mouse continuamente.",
    },
    deploy:
      "https://flightsim.to/file/43284/mouseyoke-for-msfs-fly-using-your-mouse-in-microsoft-flight-simulator-2020",
    tools: ["python"],
  ...
  },
  {
    ...
    longDesc: {
      ...
      es:
        "Este es el primer proyecto que realicé en React. Es un juego simple, en el que tienes que igualar todos los números hasta que tengan el mismo valor. Apretando sobre ellos, su valor se bloquea.",
    },
    deploy: "https://tenzies-game-delta.vercel.app/",
  ...
  },
  {
    ...
    longDesc: {
      en:
        "This was a weekend project, made for practicing responsivness. The design was made by Illia Frunza, a Figma community designer.",
      es:
        "Este fue un projecto de fin de semana, hecho para practicar diseños responsivos. El diseño fue hecho por Illia Frunza, un diseñador comunitario de Figma.",
    },
  ...
  },
  {
    ...
    longDesc: {
      en:
        "Made primarely for learning Next.js, but it turned as a real project. By using Next's i18n (Internationalization), it can be displayed on english and spanish.",
      es:
        "Creado principalmente para aprender Next.js, pero se convirtio en un proyecto real. Utilizando i18n de Next (Internacionalización) permite la presentación de multiples idiomas.",
    },
    deploy: "",
